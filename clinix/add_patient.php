...
//check if the form has been submitted 
    ...
    $employee_number = $_POST['DOB'];
    $employee_number = $_POST['height'];
    $employee_number = $_POST['weight'];
    $employee_number = $_POST['bloodgroup'];
    $gender = $_POST['history'];
    $employee_role = $_POST['gender'];
    $employee_email = $_POST['patientEmail'];
    $employee_pass = $_POST['patientNumber'];
